...
export const RasterPointCloud = () => (
  <TileImageVisualization
    ...
    height={'100vh'}
    defaultChannels={
      [{index: 1, intensity: 2000}, {index: 2, intensity: 2000}, {index: 3, intensity: 2000}]
    }
    sceneConfig={{
      pointConfigs: [{
        pickable: false,
        features: [
          {
            ...
            interleaved: true,
            attributes: [
              {name: 'Red', normalize: true, normalizationWindow: { min: 0, max: 255 }}, 
              {name: 'Green', normalize: true, normalizationWindow: { min: 0, max: 255 }}, 
              {name: 'Blue', normalize: true, normalizationWindow: { min: 0, max: 255 }}
            ]
          }
        ]
      }]
