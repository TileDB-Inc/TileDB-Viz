...
class ParticleShaderMaterial{
    ...
    constructor(
        ...
        neighbourCount = neighbourCount || 12;
        pointSize = pointSize || 3;
      
        //var depthRenderer = scene.enableDepthRenderer(scene.camera);
      ...
      //this.shaderMaterial.alpha = 0.85;
      //this.shaderMaterial.diffuseColor = new Color3(0, 0, 0);
      //this.shaderMaterial.emissiveColor = new Color3(0.5, 0.5, 0.5);
